...
exports.create = function (request, reply) {
	...
	server.seneca.act(
		{role:"recipe", cmd:"seq"}, 
		{args:[
			{role:"store", cmd:"upsert", coll:"company", criteria:criteria, entity:params},
			{role:"search", cmd:"update", type:"company", entity:params}
		]},
		function(err, out){
			reply(err || out);
		}
...
exports.delete = function (request, reply) {
	...
	server.seneca.act(
		{role:"recipe", cmd:"seq", 
		 args:[
			{role:"store", cmd:"delete", coll:"company", entity:params},
			{role:"search", cmd:"delete", type:"company", entity:params}
		]},
		function(err, out){
			reply(err || out);
		}
