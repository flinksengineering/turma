...
exports.update = function (request, reply) {
	...
	server.seneca.act(
		...
		{coll:"category", entity:params, criteria:criteria},
		function(err, out){
			reply(err || out);
		}
	);
...
exports.search = function (request, reply) {
	...
	var projection = {"_id":true, "name":true, 
		"last_modified_date":true};
	server.seneca.act(
		{role:"store", cmd:"search"}, 
		{coll:"category", entity:params, projection:projection},
		function(err, out){
			reply(err || out);
		}
	);
